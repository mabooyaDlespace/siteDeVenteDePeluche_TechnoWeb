<?php
$absoluteDirectoryName="http://localhost/TP/TP2/";
...
<html>
    ...
    <body>
        <header>
            <div class="topnav">
                <a href="<?php echo $absoluteDirectoryName; ?>page_home/index.php" id="homelogo"><img src="<?php echo $absoluteDirectoryName; ?>images/logo.png" id="logo" title="Acceuil"></a>
                <div class="topnavTexts">
                    ...
                    <a class="topnav"> Session :<?php $temp1=returnUserConnection($sessionid);echo $temp1['name']; ?> </a>
